        ...
        <div className='flex my-16 md:flex-row flex-col justify-between items-center'>
            ...
            <div className=' flex items-center md:gap-3 gap-6'>
                {socialMedia.map((profile)=>(
                    <div key={profile.id} className='w-10 h-10 cursor-pointer flex justify-center backdrop-filter backdrop-blur-lg saturate-75 bg-black-200 rounded-lg border border-black-200'>
