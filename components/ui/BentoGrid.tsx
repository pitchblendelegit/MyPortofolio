...
export const BentoGridItem = ({
  ...
  const leftLists = ["JavaScript", "Python", "SQL"];
  const rightLists = ["Node", "Django", "React"];
  ...
  const handleCopy = () => {
    const text = "halfian639@gmail.com";
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 4 && (
              <div className="mt-5">
                <a
                  href="https://drive.google.com/file/d/159FHgCJ7zebcgxteRXEn5lU-NnCtJraj/view?usp=sharing"
                  target="_blank"
            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:right-2">
              ...
              <div className="flex flex-col gap-1 md:gap-3 lg:gap-3">
                {leftLists.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-2 lg:px-2 py-1 px-2 text-xs lg:text-sm opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
